...
1. **Bu, Q.**, Su, W., Zhao, X., and Liu, Z.  
   Semiparametric causal inference for right-censored outcomes with many weak and invalid instruments.  
   *(Under review)*

1. **Bu, Q.**, Li, B., and Zhang, X.  
   Electricity load forecasting via tensor regression with model averaging.  
   *(Under review)*
   
1. Zhang, H., **Bu, Q.**, and Zhang, X.  
   Weighted deep ensemble under misspecification.  
   *(Under review)*

1. Gao, Y., Liu, M., **Bu, Q.**, Zhang, J., Li, J., Xiong, W., Liang, X., Li, C., Yang, W., Zhang, K., Dong, Y., Zhou, L., Zhuang, J., Gong, Z., Gao, Y., Fu, L., Xiao, T., Luo, L., Sun, W., Geng, Y., Song, Y., Jiang, M., Liu, W., Duan, Z., Yang, L., Song, Q., Lu, H., Zhang, X., and Hu, Z.  
   A multicenter real-world study evaluating oral antiviral agents in hospitalized COVID-19 patients in China.  
   *(Under review)*

1. Gan, Q., Zhang, H., Gao, Y., Zhu, R., **Bu, Q.**, Wang, Q., Gao, Y., Zhao, Y., Wang, J., and Zhang, X.  
...
1. **Bu, Q.**, Su, W., Zhang, X., and Zhao, X.  
